...
def webParse(url) -> str:
    possible_author_class = [re.compile(r'.*contributor[name].*', re.IGNORECASE), re.compile(r'.*author[name].*', re.IGNORECASE), re.compile(r'.*[script]writer[name].*', re.IGNORECASE)]
